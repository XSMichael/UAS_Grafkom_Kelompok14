...
namespace UAS_Digimon
{
    ...
    class Window : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            for (int i = 1; i <= 9; i++)
            {
                character = new Asset3d(botamon + i + "/body" + i + ".obj", "normalShader.vert", "normalShader.frag", new Vector3(54, 54, 54) / 255, new Vector3(54, 54, 54) / 255, new Vector3(1, 1, 1)); //Hitam
